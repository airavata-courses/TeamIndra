...
sudo chmod 777 .
sudo chmod a+w '/home/ec2-user/builds/Auth Service/'
...
sudo chmod a+w '/home/ec2-user/builds/Data Service/'
...
sudo chmod a+w '/home/ec2-user/builds/Gateway Web Service/'
